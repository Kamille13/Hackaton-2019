...
public class Enigme6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        try {
                            ...
                            reponse.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    MediaPlayer mpVous = MediaPlayer.create(Enigme6Activity.this,R.raw.ring);
                                    mpVous.start();
        ...
        Button button1 = findViewById(R.id.button25);
        Button button2 = findViewById(R.id.button27);
        Button button3 = findViewById(R.id.button28);
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Enigme6Activity.this, "Mauvaise réponse ", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Enigme6Activity.this,MapsActivity.class);
                MediaPlayer mpVous = MediaPlayer.create(Enigme6Activity.this,R.raw.haha);
                mpVous.start();
                startActivity(intent);
            }
        });
